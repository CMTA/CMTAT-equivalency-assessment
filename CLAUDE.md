...
- The document currently holds **61 numbered criteria**: **19 mandatory** (IDs 1–3, 7–11, 14–21, 29–31) and **42 optional** (IDs 4–6, 12–13, 22–28, 32–61).
- Those figures appear in four places that must always agree: the `Scope of the count` table, the `Compliance table` column headers `Mandatory (19)` / `Optional (42)`, the sum rule underneath it, and the example filled table. Update all four together.
