...
It is a companion to `CMTAT_SUGGESTION`, which carries the substantive suggestions, alongside `CMTAT_SUGGESTION_CROSSCHAIN` and `CMTAT_SUGGESTION_PRIVACY`. It is a suggestion list produced by this repository, not a CMTA publication.
